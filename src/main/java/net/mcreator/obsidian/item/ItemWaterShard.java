...
import net.mcreator.obsidian.procedure.ProcedureWaterShardRightClickedInAir;
...
public class ItemWaterShard extends ElementsWaterandLava.ModElement {
	@GameRegistry.ObjectHolder("obsidian:watershard")
	public static final Item block = null;
	public ItemWaterShard(ElementsWaterandLava instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("obsidian:watershard", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureWaterShardRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
