...
package net.mcreator.obsidian.world;
...
import net.mcreator.obsidian.procedure.ProcedureObsidianDimensionPlayerLeavesDimension;
import net.mcreator.obsidian.item.ItemObsidianDimension;
import net.mcreator.obsidian.block.BlockSuperchargedObsidian;
import net.mcreator.obsidian.block.BlockLiquidobsidian;
...
public class WorldObsidianDimension extends ElementsWaterandLava.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("obsidian:obsidiandimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldObsidianDimension(ElementsWaterandLava instance) {
		super(instance, 96);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemObsidianDimension.block, 0,
				new ModelResourceLocation("obsidian:obsidiandimension", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerRemoved(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureObsidianDimensionPlayerLeavesDimension.executeProcedure($_dependencies);
			}
		}
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag
											? BlockSuperchargedObsidian.block.getDefaultState().getBlock().getDefaultState()
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockSuperchargedObsidian.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockSuperchargedObsidian.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockSuperchargedObsidian.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockSuperchargedObsidian.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height))
							.getBlock() != BlockSuperchargedObsidian.block.getDefaultState().getBlock()) {
						this.height = 0;
						break;
					}
				}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.OBSIDIAN.getDefaultState();
		private static final IBlockState STONE2 = Blocks.STONE.getStateFromMeta(0);
		private static final IBlockState FLUID = BlockLiquidobsidian.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("obsidian:primordialocean")),
				Biome.REGISTRY.getObject(new ResourceLocation("obsidian:extreamearth")), Biome.REGISTRY.getObject(new ResourceLocation("ocean")),
