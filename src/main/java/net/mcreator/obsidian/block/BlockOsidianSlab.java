...
public class BlockOsidianSlab extends ElementsWaterandLava.ModElement {
	@GameRegistry.ObjectHolder("obsidian:osidianslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("obsidian:osidianslab_double")
	public static final Block block_slab_double = null;
	public BlockOsidianSlab(ElementsWaterandLava instance) {
		super(instance, 49);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("osidianslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("osidianslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("obsidian:osidianslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("osidianslab");
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockOsidianSlab.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockOsidianSlab.block, (int) (1)));
		}
	}
}
